...
INSERT INTO members (id, club_id, first_name, last_name, handicap, phone, email, role) VALUES
  ('m0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'James', 'Murphy', 12, '087 123 4567', 'james.murphy@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Mick', 'Ryan', 10, '087 678 9012', 'm.ryan@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Brian', 'Nolan', 9, '088 789 0123', 'b.nolan@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Sean', 'Walsh', 6, '085 345 6789', 'swalsh@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'David', 'Kelly', 8, '083 456 7890', 'd.kelly@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Eoin', 'Brennan', 11, '086 890 1234', 'e.brennan@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Ronan', 'Collins', 15, '089 901 2345', 'r.collins@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Patrick', 'O''Brien', 14, '086 234 5678', 'p.obrien@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Liam', 'Byrne', 16, '085 012 3456', 'l.byrne@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Fergal', 'Healy', 13, '087 345 6789', 'f.healy@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000011', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Kevin', 'Flynn', 17, '083 456 7891', 'k.flynn@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000012', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Colm', 'Dunne', 20, '089 567 8902', 'c.dunne@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000013', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Niall', 'Foley', 19, '086 678 9013', 'n.foley@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000014', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Alan', 'Keane', 22, '085 789 0124', 'a.keane@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000015', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Ger', 'Power', 21, '087 890 1235', 'g.power@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000016', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Tom', 'Doyle', 18, '089 567 8901', 'tdoyle@email.com', 'golfer'),
  ('m0000001-0000-0000-0000-000000000099', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Mary', 'Connolly', 0, '087 999 0000', 'mary.connolly@email.com', 'organiser');
